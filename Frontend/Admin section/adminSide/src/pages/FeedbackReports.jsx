...
const FeedbackReports = () => {
    // Mock data
    const reports = [
        { id: 1, prof: 'Prof. Praful Kolte', module: 'C++', first: '4.1/5', second: '3.9/5.0', avg: '4.0/5.0', comments: 'check' },
        { id: 2, prof: 'Dr. Jane Smith', module: 'Java', first: '4.5/5', second: '4.2/5.0', avg: '4.35/5.0', comments: 'check' },
        { id: 3, prof: 'Dr. Alan Turing', module: 'Algorithms', first: '4.8/5', second: '4.9/5.0', avg: '4.85/5.0', comments: 'check' },
    ];
                        ...
                        <tbody>
                            {reports.map((report) => (
                                <tr key={report.id} className="border-b border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td className="p-3">
                                        <button className="text-blue-600 hover:underline font-semibold">{report.comments}</button>
                                    </td>
                                </tr>
                            ))}
