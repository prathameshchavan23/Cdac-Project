  ...
  1: [
    {
      ...
      first: "4/5",
      second: "4.5/5",
      comment: "Excellent teaching style, very clear.",
    },
    {
      id: 102,
      first: "3/5",
      second: "4/5",
      comment: "Pacing was a bit fast at times.",
    },
    {
      id: 103,
      first: "5/5",
      second: "5/5",
      comment: "Best professor for this subject!",
    },
  ],
  2: [
    {
      ...
      first: "5/5",
      second: "4.5/5",
      comment: "Very engaging and helpful.",
    },
  ],
  3: [
    {
      ...
      first: "3/5",
      second: "3.5/5",
      comment: "More practical examples would be useful.",
    },
...
const Feedback = () => {
  ...
  const handleUpdateFeedback = (e) => {
    e.preventDefault();
    setFeedbacks(
      feedbacks.map((f) => (f.id === editingFeedback.id ? editingFeedback : f))
    );
  ...
  const handleDeleteComment = (commentId) => {
    if (window.confirm("Are you sure you want to delete this comment?")) {
      ...
      updatedReports[selectedFeedbackId] = updatedReports[
        selectedFeedbackId
      ].filter((report) => report.id !== commentId);
            ...
            <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md relative">
              ...
              <form onSubmit={handleAddFeedback} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    id="instructorName"
                    value={newFeedback.instructorName}
                    onChange={(e) =>
                      setNewFeedback({
                        ...newFeedback,
            ...
            <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md relative">
              ...
              <form onSubmit={handleUpdateFeedback} className="space-y-6">
                <div>
                  ...
                  <select
                    id="editModuleName"
                    value={editingFeedback.moduleName}
                    onChange={(e) =>
                      setEditingFeedback({
                        ...editingFeedback,
                        moduleName: e.target.value,
                ...
                <div>
                  ...
                  <select
                    ...
                    value={editingFeedback.instructorName}
                    onChange={(e) =>
                      setEditingFeedback({
                        ...editingFeedback,
                        instructorName: e.target.value,
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-slate-500 mt-1">
                Manage feedback schedules and reports
              </p>
            </div>
            <div className="flex space-x-2">
              <button
                onClick={() => setAddModalOpen(true)}
                className="bg-blue-800 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-blue-900 flex items-center gap-2"
              >
                ...
                <tbody>
                  {feedbacks.map((item) => (
                    ...
                    >
                      ...
                      <td className="p-4">
                        <button
                          onClick={() => navigateToDashboard(item.id)}
                      ...
                      <td className="p-4 flex justify-center items-center gap-2">
                        <button
                          ...
                          className="bg-blue-600 text-white px-4 py-1 rounded-md text-sm flex items-center gap-1"
                        >
                          <Edit size={14} />
                          Edit
                        </button>
                        <button
                          ...
                          className="bg-red-600 text-white px-4 py-1 rounded-md text-sm flex items-center gap-1"
                        >
                          <Trash2 size={14} />
                          Delete
                        </button>
  ...
  // -----------------------------------------------------------------------------------
  if (view === "dashboard") {
    const data = feedbackSummaryData[selectedFeedbackId] || {
      instructorName: "N/A",
      moduleName: "N/A",
      avgRating: "N/A",
      totalSubmissions: 0,
    ...
    return (
      <div className="p-8 bg-slate-50 min-h-full">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-500 mt-1">
            Summary for{" "}
            <span className="font-semibold">{data.instructorName}</span> on{" "}
            <span className="font-semibold">{data.moduleName}</span>
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="p-6 bg-green-100 border border-green-300 rounded-xl text-center">
            ...
            <p className="text-5xl font-bold text-green-900 my-2">
          ...
          <div className="p-6 bg-red-100 border border-red-300 rounded-xl text-center">
            ...
            <p className="text-5xl font-bold text-red-900 my-2">
              {data.pending}
            </p>
        ...
        <div className="flex justify-end">
          <button
            onClick={() => navigateToReports(selectedFeedbackId)}
            className="bg-gray-800 text-white px-5 py-2 rounded-lg shadow-sm hover:bg-gray-900"
          >
            Check Comments
          </button>
        </div>
                  ...
                  >
                    ...
                    <td className="p-3 text-center">
                      <button
                        ...
                        className="bg-red-600 text-white px-3 py-1 rounded-md text-sm flex items-center gap-1 mx-auto"
                      >
